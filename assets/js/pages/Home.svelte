...
<svelte:head>
  <title>Songy - Music Game Platform</title>
</svelte:head>
...
<div class="wrapper">
  ...
  {:else}
    <form class="providers" use:inertia={{ href: "/create", method: "post" }}>
      <button type="submit" class="btn btn-success w-3xs"> Create game </button>
    </form>
  {/if}
</div>
